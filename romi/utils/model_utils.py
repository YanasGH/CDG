import numpy as np
from mopo.mopo.models.constructor import construct_model, format_samples_for_training, format_reverse_samples_for_training
import mopo.mopo.static
...
def initialize_fake_env(env, args):
    ...
    domain = args.domain
    static_fns = mopo.mopo.static[domain.lower()]
    ...
    if 'antmaze' in args.env_name:
        samples = dataset_utils.processed_qlearning_dataset(args, env, args.env_name, timeout_frame=False, done_frame=True)
    else:
        samples = dataset_utils.processed_qlearning_dataset(args, env, args.env_name, timeout_frame=False, done_frame=False)
